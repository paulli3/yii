...
class paysgh extends paybase
{
	...
	public function pay($uid,$money)
	{
		...
		$apiUrl = sghapi::exchange($uid,$this->sid,$orderid,$money);
		
		$flag = sghapi::apiCurl($apiUrl);
	    
		$this->log($apiUrl, $flag);
		
	    return sghapi::checkStat($flag) ? self::PAY_SUCCESS : self::PAY_FAIL; //1成功，0失败
	}
}
